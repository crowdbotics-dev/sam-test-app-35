"""
Django settings for sam_test_app_35 project.
...
ROOT_URLCONF = 'sam_test_app_35.urls'
...
WSGI_APPLICATION = 'sam_test_app_35.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "sam-test-app Support <support@sam-test-app-35.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sam_test_app_35 API",
    "DESCRIPTION": "API documentation for sam_test_app_35 App",
    "VERSION": "v1",
}
